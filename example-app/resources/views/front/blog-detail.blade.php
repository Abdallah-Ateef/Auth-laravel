...
@section('content')
@include('front.layouts.sub-header',['pagename'=>'Blog Detail']) 
<div class="container py-5">
    <div class="row pt-5">
      <div class="col-lg-8">
        ...
        <div class="mb-5">
          <img
            ...
            src="{{asset('frontend')}}/img/detail.jpg"
            alt="Image"
          />
          <p>
          ...
          <img
            ...
            src="{{asset('frontend')}}/img/blog-2.jpg"
            alt="Image"
          />
          <p>
            Diam dolor est labore duo invidunt ipsum clita et, sed et lorem
        ...
        <div class="mb-5 mx-n3">
          ...
          <div class="owl-carousel post-carousel position-relative">
            ...
            >
              <img
                class="img-fluid"
                src="{{asset('frontend')}}/img/post-1.jpg"
            ...
            >
              <img
                class="img-fluid"
                src="{{asset('frontend')}}/img/post-2.jpg"
                style="width: 80px; height: 80px"
              />
              <div class="pl-3">
                <h5 class="">Diam amet eos at no eos</h5>
            ...
            >
              <img
                class="img-fluid"
                src="{{asset('frontend')}}/img/post-3.jpg"
                style="width: 80px; height: 80px"
              />
              <div class="pl-3">
                <h5 class="">Diam amet eos at no eos</h5>
        ...
        <div class="mb-5">
          ...
          <div class="media mb-4">
            <img
              src="{{asset('frontend')}}/img/user.jpg"
              alt="Image"
      ...
      <div class="col-lg-4 mt-5 mt-lg-0">
        ...
        <!-- Single Image -->
        <div class="mb-5">
          <img src="{{asset('frontend')}}/img/blog-1.jpg" alt="" class="img-fluid rounded" />
        </div>
        ...
        <!-- Single Image -->
        <div class="mb-5">
          <img src="{{asset('frontend')}}/img/blog-2.jpg" alt="" class="img-fluid rounded" />
        </div>
        ...
        <!-- Single Image -->
        <div class="mb-5">
          <img src="{{asset('frontend')}}/img/blog-3.jpg" alt="" class="img-fluid rounded" />
        </div>
